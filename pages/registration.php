...
<main>
    ...
    <div class="authorization_form">
        <h1>Регистрация</h1>
        <form class="form_auth" action="../components/reg.php" method="post">
            <div class="input_str">
                <img class="input_img" src="../img/name_input.png" alt="">
                <input class="input_text input_auth" type="text" name="name" placeholder="Ваше имя">
            </div>
            <div class="input_str">
            ...
            <div class="input_str">
                <img class="input_img" src="../img/phone_input.png" alt="">
                <input class="input_text input_auth tel" type="text" name="phone" placeholder="+7(___)___-__-__">
            </div>
            <input class="form_button input_auth" type="submit" value="Зарегистрироваться">
        </form>
    </div>
</main>
